...
{
    public class HardwareTypeResponseForGroup : ResponseMessage
    {
        public HardwareTypeResponseForGroup() : base((short)Module.FrameType.HardwareTypeMessageToGroup)
        {
        }

        public HardwareTypeResponseForGroup(Frame frame) : base(frame)
        {
        }
